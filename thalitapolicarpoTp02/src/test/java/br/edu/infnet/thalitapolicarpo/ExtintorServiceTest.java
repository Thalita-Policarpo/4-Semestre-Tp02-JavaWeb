...
public class ExtintorServiceTest {
    ...
    public void testObterTodos() {
        ...
        Map<Integer, Extintor> todosExtintores = extintorService.obterTodos();
        assertEquals(2, todosExtintores.size());
        assertEquals(extintor1, todosExtintores.get(1));
        assertEquals(extintor2, todosExtintores.get(2));
    }
}
